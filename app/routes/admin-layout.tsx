        ...
        <div className="h-full border-r border-gray-200 dark:border-gray-700 bg-[#1c7b80]/5 dark:bg-gray-800 flex flex-col shadow-md relative overflow-hidden">
          ...
          <div
            ...
            style={{
              ...
              height: sidebarOpen ? '190px' : '80px',
              transition: 'height 0.3s ease'
            }}
          >
            <div className="flex items-center h-16 px-4 w-full pt-3 justify-between">
              {sidebarOpen && (
                <>
                  <div className="flex items-center">
          ...
          <nav className="flex-1 overflow-y-auto pt-5 px-3">
            ...
            <Button
              ...
              className={`
                ...
                text-red-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white
                transition-all duration-200
              `}
            >
              <LogOut
                className={`
                  ...
                  h-5 w-5 text-red-700 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300
                `}
              />
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center">
                <div className="relative group">
                  <div className="flex items-center space-x-1 dark:bg-gray-700/50 px-4 py-1.5 rounded-full">
