...
// routes/admin/reports/download.$id.tsx

import type * as T from "react-router/route-module"

import type { Info as Parent0 } from "../../../../+types/root.js"

type Module = typeof import("../download.$id.js")

export type Info = {
  parents: [Parent0],
  id: "routes/admin/reports/download.$id"
  file: "routes/admin/reports/download.$id.tsx"
  path: "/admin/reports/download/:id"
